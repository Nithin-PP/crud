        ...
        <form id="form" action="{{url('update')}}" name="form" method="post" enctype="multipart/form-data">
            ...
            Qualification:
                <select name="qualification" id="qualification" class="form-control color">
                    <option value="{{$edited['qualification']}}">select</option>
                    <option value="{{$edited['qualification']}}">Btech</option>
                    <option value="{{$edited['qualification']}}">Bcom</option>
                    <option value="{{$edited['qualification']}}">Bsc</option>
                </select>
            </div>
